...
description: "Use this skill when the user wants to audit OpenClaw costs, token usage, API spend, billing trends, or cost-saving opportunities. It parses logs, builds reports, and helps forecast spend with alerts."
triggers:
