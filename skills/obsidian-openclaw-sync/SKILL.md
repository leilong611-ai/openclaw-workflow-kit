...
description: Use this skill when the user wants to sync OpenClaw-related Obsidian
  config across devices, manage iCloud symlinks, or troubleshoot multi-device vault
  setup.
